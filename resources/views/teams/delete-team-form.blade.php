<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="test-sm text-muted">
            {{ __('Once an organisation is deleted, all of its resources and data will be permanently deleted. Before deleting this organisation, please download any data or information that you wish to retain.') }}
        </div>
        ...
        <x-jet-confirmation-modal wire:model="confirmingTeamDeletion">
            ...
            <x-slot name="content">
                {{ __('Are you sure you want to delete this organisation? Once an organisation is deleted, all of its resources and data will be permanently deleted.') }}
            </x-slot>
