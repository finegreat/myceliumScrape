<div>
    @if (Gate::check('addTeamMember', $team))
        ...
        <x-jet-form-section submit="addTeamMember">
            <x-slot name="title">
                {{ __('Add Organisation User') }}
            </x-slot>

            <x-slot name="description">
                {{ __('Add a new user to your organisation, allowing them to collaborate with you.') }}
            </x-slot>
            ...
            <x-slot name="form">
                ...
                <div class="mb-3">
                    {{ __('Please provide the email address of the person you would like to add to this organisation.') }}
                </div>
    ...
    @if ($team->teamInvitations->isNotEmpty() && Gate::check('addTeamMember', $team))
        ...
        <x-jet-action-section>
            <x-slot name="title">
                {{ __('Pending Organisation Invitations') }}
            </x-slot>

            <x-slot name="description">
                {{ __('These people have been invited to your organisation and have been sent an invitation email. They may join the organisation by accepting the email invitation.') }}
            </x-slot>
    ...
    @if ($team->users->isNotEmpty())
        ...
        <x-jet-action-section>
            ...
            <x-slot name="description">
                {{ __('All of the people that are part of this organisation.') }}
            </x-slot>
    ...
    <x-jet-confirmation-modal wire:model="confirmingLeavingTeam">
        <x-slot name="title">
            {{ __('Leave Organisation') }}
        </x-slot>

        <x-slot name="content">
            {{ __('Are you sure you would like to leave this organisation?') }}
        </x-slot>
    ...
    <x-jet-confirmation-modal wire:model="confirmingTeamMemberRemoval">
        ...
        <x-slot name="content">
            {{ __('Are you sure you would like to remove this person from the organisation?') }}
        </x-slot>
